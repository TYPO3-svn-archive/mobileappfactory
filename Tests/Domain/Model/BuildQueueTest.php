...
/**
 * Testcase for class Tx_Mobileappfactory_Domain_Model_BuildQueue.
 *
 * @version $Id$
 ...
 *
 */
class Tx_Mobileappfactory_Domain_Model_BuildQueueTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Mobileappfactory_Domain_Model_BuildQueue
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Mobileappfactory_Domain_Model_BuildQueue();
	}
